/**
 * Submits the `vendor_advance_decision_v1` WhatsApp template to Meta (via
 ...
 *
 *   node scripts/create-advance-decision-template.mjs           # status only
 *   node scripts/create-advance-decision-template.mjs --submit  # create at Meta
 */
import fs from "node:fs";
import path from "node:path";

const SUBMIT = process.argv.includes("--submit");
const TEMPLATE_NAME = "vendor_advance_decision_v1";
const BODY =
...
const SAMPLE = ["Prosync AI Solutions", "Your advance request of Rs 45,000 has been approved."];
